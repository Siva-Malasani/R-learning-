library(data.table)
Claims = fread("C://Users/himanshu arora/Documents/Data Science/Analytics Edge/Unit 4/Healthcare Costs, Case - 2/ClaimsData.csv")


Claims<-fread(input = "https://storage.googleapis.com/dimensionless/Analytics/ClaimsData.csv",sep=",",header = T,stringsAsFactors = T)
